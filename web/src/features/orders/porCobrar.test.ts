...
describe('lo que falta cobrar', () => {
  ...
  it('junta lo sin cobrar de los pedidos activos y de los entregados', () => {
    const activos = [
      ...
      orden({ id: 2, paid: false, total: '150', outstanding: '150' }),
    ];
    const entregados = [
      orden({ id: 3, paid: false, total: '80', outstanding: '80', status: 'entregada' }),
    ];
  ...
  it('el resumen dice cuántos y cuánto', () => {
    const r = resumenPorCobrar([
      orden({ id: 2, paid: false, total: '150', outstanding: '150' }),
      orden({ id: 3, paid: false, total: '80.50', outstanding: '80.50' }),
  ...
  it('un pedido abonado cuenta solo por lo que falta', () => {
    const r = resumenPorCobrar([
      orden({ id: 6, paid: false, total: '250', outstanding: '150' }),
    ]);
  ...
  it('lo cancelado no cuenta como por cobrar', () => {
    const r = resumenPorCobrar([orden({ id: 5, paid: false, total: '200', outstanding: '200', status: 'cancelada' })]);
