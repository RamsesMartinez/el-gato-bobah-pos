...
- [ ] T074 [US4] Agregar el upsert y el delete de `modifier_option_platform_prices` y correr `make sqlc`
- [ ] T075 **[test]** [US4] Test de integración: el delta manual persiste por plataforma, **acepta 0** y rechaza negativos
- [ ] T076 [US4] Servicio y handlers `PUT`/`DELETE /platform-prices/modifier-option`
- [ ] T077 **[test]** [P] [US4] Test de la UI de corrección de una opción
- [ ] T078 [US4] UI para corregir el precio de una opción desde `ModifierSheet`
...
- [ ] T080 [P] Revisar los textos de la pantalla contra el principio de UI de la constitución: nada que solo entienda quien leyó el código
- [ ] T081 Gates: `make api-build && make api-test`, `bun run test`, `bun run typecheck`, `bun run build`, y los hooks de lefthook en verde
- [ ] T082 Pasar el subagente `go-backend-reviewer` sobre el diff de backend
